...
const weeklyCalorieData = [
  { day: "Mon", calories: 2000, protein: 120, carbs: 210, fat: 65 },
  { day: "Tue", calories: 1950, protein: 115, carbs: 200, fat: 60 },
  { day: "Wed", calories: 2250, protein: 140, carbs: 230, fat: 75 },
  { day: "Thu", calories: 2100, protein: 130, carbs: 220, fat: 70 },
  { day: "Fri", calories: 2300, protein: 145, carbs: 235, fat: 80 },
  { day: "Sat", calories: 2500, protein: 155, carbs: 250, fat: 85 },
  { day: "Sun", calories: 2150, protein: 125, carbs: 225, fat: 75 }
];

const macroDistributionData = [
  { name: "Protein", value: 25, color: "#3B82F6" }, // ~25% of calories
  { name: "Carbs", value: 45, color: "#F59E0B" },   // ~45% of calories
  { name: "Fat", value: 30, color: "#8B5CF6" }      // ~30% of calories
];

const nutrientComparisonData = [
  { name: "Vitamin A", actual: 80, target: 100 },
  { name: "Vitamin C", actual: 65, target: 90 },
  { name: "Vitamin D", actual: 10, target: 20 },
  { name: "Iron", actual: 14, target: 18 },
  { name: "Calcium", actual: 850, target: 1000 },
  { name: "Zinc", actual: 9, target: 11 }
];

const mealTimingData = [
  { time: "6-9 AM", calories: 500, name: "Breakfast" },
  { time: "9-11 AM", calories: 200, name: "Snack" },
  { time: "12-2 PM", calories: 700, name: "Lunch" },
  { time: "2-5 PM", calories: 150, name: "Snack" },
  { time: "6-8 PM", calories: 600, name: "Dinner" },
  { time: "8-10 PM", calories: 100, name: "Snack" }
];
...
const CustomTooltip = ({ active, payload, label }: any) => {
  if (active && payload && payload.length) {
    return (
      <div className="p-3 bg-white dark:bg-gray-800 border shadow-md rounded-lg">
...
const chartConfig = {
  ...
  protein: { color: "#10B981", label: "Protein" },
  carbs: { color: "#F59E0B", label: "Carbs" },
  fat: { color: "#8B5CF6", label: "Fat" },
  actual: { color: "#3B82F6", label: "Actual" },
  target: { color: "#10B981", label: "Target" }
};
