...
import { Users, MessageSquare, Heart, Share2, Award, Activity, ThumbsUp, Send, Clock, Plus } from "lucide-react";
...
const SocialFeed = () => {
  ...
  return (
    <Card className="shadow hover:shadow-lg transition-all duration-300">
        ...
        <div className="space-y-4">
          {feed.map((item) => (
            <motion.div 
              ...
              className="p-4 border border-gray-100 dark:border-gray-800 rounded-lg hover:shadow-md transition-all duration-300"
            >
