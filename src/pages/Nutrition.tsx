      ...
      <Tabs defaultValue="track" className="space-y-6">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div className="flex items-center p-2 border-b">
                        <div className="bg-red-100 p-2 rounded-full mr-3 dark:bg-red-900/30">
                          <Apple className="h-4 w-4 text-red-600" />
                        </div>
                        <div>
                          <h4 className="font-medium">Fruits</h4>
                          <p className="text-xs text-gray-500">Apples, berries, citrus</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center p-2 border-b">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">Leafy greens, cruciferous</p>
                        </div>
                      </div>
                      
                      <div className="flex items-center p-2 border-b">
                        <div className="bg-amber-100 p-2 rounded-full mr-3 dark:bg-amber-900/30">
                          <Beef className="h-4 w-4 text-amber-800" />
                        </div>
                        <div>
                          <h4 className="font-medium">Proteins</h4>
                          <p className="text-xs text-gray-500">Lean meats, tofu, legumes</p>
                        </div>
                      </div>
                      
                      <div className="flex items-center p-2 border-b">
                        <div className="bg-yellow-100 p-2 rounded-full mr-3 dark:bg-yellow-900/30">
                          <Coffee className="h-4 w-4 text-yellow-800" />
                        </div>
                        <div>
                          <h4 className="font-medium">Grains</h4>
                          <p className="text-xs text-gray-500">Whole grains, quinoa</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center p-2">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500">Avocados, nuts, olive oil</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
          ...
          >
            <Card>
              <CardHeader>
                ...
                <CardDescription>Detailed breakdown of your nutritional intake</CardDescription>
              </CardHeader>
              <CardContent>
                <Tabs defaultValue={activeAnalysisTab} onValueChange={setActiveAnalysisTab} className="space-y-4">
                  <TabsList>
                  ...
                  <TabsContent value="macros">
                    <div className="grid gap-6 md:grid-cols-2">
                        ...
                        <div className="space-y-6">
                          <div className="flex items-center justify-between">
                            <div className="space-y-0">
                              <Label className="text-sm">Carbohydrates</Label>
                              <p className="text-2xl font-bold">{totals.carbs}g</p>
                              <p className="text-xs text-gray-500 dark:text-gray-400">{Math.round((totals.carbs * 4 / (totals.calories || 1)) * 100)}% of total calories</p>
                            </div>
                            <div className="h-20 w-20 bg-amber-100 dark:bg-amber-900/30 rounded-full flex items-center justify-center">
                              <span className="text-xl font-bold text-amber-600 dark:text-amber-400">{Math.round((totals.carbs / nutritionGoals.carbs) * 100)}%</span>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="space-y-0">
                              ...
                              <p className="text-xs text-gray-500 dark:text-gray-400">{Math.round((totals.protein * 4 / (totals.calories || 1)) * 100)}% of total calories</p>
                            </div>
                            <div className="h-20 w-20 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center">
                              <span className="text-xl font-bold text-blue-600 dark:text-blue-400">{Math.round((totals.protein / nutritionGoals.protein) * 100)}%</span>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center justify-between">
                            <div className="space-y-0">
                              ...
                              <p className="text-xs text-gray-500 dark:text-gray-400">{Math.round((totals.fat * 9 / (totals.calories || 1)) * 100)}% of total calories</p>
                            </div>
                            <div className="h-20 w-20 bg-red-100 dark:bg-red-900/30 rounded-full flex items-center justify-center">
                              <span className="text-xl font-bold text-red-600 dark:text-red-400">{Math.round((totals.fat / nutritionGoals.fat) * 100)}%</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div>
                        <h3 className="text-lg font-medium mb-4">Recommended vs. Actual</h3>
                        <div className="space-y-6">
                          <div>
                            <div className="flex justify-between mb-1">
                          ...
                          <div className="mt-4 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                            <h4 className="text-sm font-medium mb-2">Nutritionist Insight</h4>
                            <p className="text-xs text-gray-600 dark:text-gray-400">
                              Your protein intake is on track! Consider increasing complex carbohydrates from whole grains and reducing saturated fats.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <TabsContent value="micros">
                    <div className="space-y-6">
                      <h3 className="text-lg font-medium">Micronutrient Status</h3>
                      
                      <div className="grid gap-4 md:grid-cols-2">
                        {micronutrientData.map((nutrient) => (
                          <div key={nutrient.name} className="p-3 border rounded-lg">
                            <div className="flex justify-between items-center mb-2">
                              <span className="font-medium">{nutrient.name}</span>
                              <span className="text-sm">{nutrient.value}% of goal</span>
                            </div>
                            <Progress 
                            ...
                            <p className="text-xs mt-2 text-gray-500 dark:text-gray-400">
                              Target: 100% ({nutrient.goal} {nutrient.unit})
                            </p>
                          </div>
                        ))}
                      </div>
                      ...
                      <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Consider adding more vitamin D-rich foods like fatty fish and egg yolks to your diet. Your calcium and iron levels could also use improvement.
                        </p>
                      </div>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="trends">
                    <div className="space-y-6">
                      <div className="flex items-center justify-between">
                        <h3 className="text-lg font-medium">Nutritional Trends</h3>
                        <div className="flex space-x-2">
                          <Button 
                            variant={activeTrendsTimeframe === 'week' ? 'default' : 'outline'} 
                            size="sm"
                            onClick={() => setActiveTrendsTimeframe('week')}
                          >
                            Week
                          </Button>
                          <Button 
                            variant={activeTrendsTimeframe === 'month' ? 'default' : 'outline'} 
                            size="sm"
                            onClick={() => setActiveTrendsTimeframe('month')}
                          >
                            Month
                          </Button>
                        </div>
                      ...
                      <div className="rounded-lg border p-3">
                        <h4 className="font-medium mb-4">Calorie Intake Trend</h4>
                        <div className="h-48 w-full">
                          <div className="flex items-end justify-between h-36">
                            {weeklyNutritionData.map((day, i) => (
                              <div key={i} className="flex flex-col items-center">
                                <div 
                                  className={`w-12 rounded-t-sm ${i === 6 ? 'bg-green-500' : 'bg-green-200 dark:bg-green-700'}`} 
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="rounded-lg border p-3">
                          <h4 className="font-medium mb-2">Protein Trend</h4>
                          <div className="h-24">
                            <div className="flex items-end justify-between h-16">
                              {weeklyNutritionData.map((day, i) => (
                                <div key={i} className="flex flex-col items-center">
                                  <div 
                                    className={`w-6 rounded-t-sm ${i === 6 ? 'bg-blue-500' : 'bg-blue-200 dark:bg-blue-700'}`} 
                                    style={{ height: `${(day.protein / 150) * 100}%` }}
                                  ></div>
                        ...
                        <div className="rounded-lg border p-3">
                          <h4 className="font-medium mb-2">Carbs Trend</h4>
                          <div className="h-24">
                            <div className="flex items-end justify-between h-16">
                              {weeklyNutritionData.map((day, i) => (
                                <div key={i} className="flex flex-col items-center">
                                  <div 
                                    className={`w-6 rounded-t-sm ${i === 6 ? 'bg-amber-500' : 'bg-amber-200 dark:bg-amber-700'}`} 
                        ...
                        <div className="rounded-lg border p-3">
                          <h4 className="font-medium mb-2">Fat Trend</h4>
                          <div className="h-24">
                            <div className="flex items-end justify-between h-16">
                              {weeklyNutritionData.map((day, i) => (
                                <div key={i} className="flex flex-col items-center">
                                  <div 
                                    className={`w-6 rounded-t-sm ${i === 6 ? 'bg-red-500' : 'bg-red-200 dark:bg-red-700'}`} 
                                    style={{ height: `${(day.fat / 100) * 100}%` }}
                                  ></div>
        ...
        <TabsContent value="routine">
          <motion.div
            ...
            className="space-y-6"
          >
            {/* Diet Routine content goes here */}
          </motion.div>
        </TabsContent>
